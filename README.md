...
> Универсальный скрипт-дашборд для мониторинга системы и управления **Entware** на роутерах **Keenetic**. Удобное управление в одном месте: мониторинг системы, установка сервисов, обновления, управление дисками и полезные ссылки на официальные источники.
...
```
opkg install curl && curl -L -s "https://raw.githubusercontent.com/LostGit77/ENTWARE-Dashboard/refs/heads/dev/install_dashboard.sh" > /tmp/banner.sh && sh /tmp/banner.sh
```
## 🧹 Удаление
...
```
curl -L -s "https://raw.githubusercontent.com/LostGit77/ENTWARE-Dashboard/refs/heads/dev/install_dashboard.sh" > /tmp/banner.sh && sh /tmp/banner.sh
```
---
